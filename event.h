...
#define GRAB_POINTER_MASK (ButtonPressMask | ButtonReleaseMask | ButtonMotionMask)

#define GRAB_KEY_MASK (KeyPressMask | KeyReleaseMask)

#define ROOT_MASK                                                                        \
  (SubstructureRedirectMask | ColormapChangeMask | ButtonPressMask | ButtonReleaseMask | \
   PropertyChangeMask | KeyPressMask | FocusChangeMask | EnterWindowMask)

#define BAR_MASK                                                                            \
  (FocusChangeMask | ButtonPressMask | ButtonReleaseMask | KeyPressMask | EnterWindowMask | \
   ExposureMask)
...
#define CLIENT_MASK                                                                 \
  (ColormapChangeMask /*|EnterWindowMask*/ | PropertyChangeMask | FocusChangeMask | \
   StructureNotifyMask)
