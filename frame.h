...
extern void frame_detach_clientwin(WFrame *frame, struct _WClientWin *cwin, int x, int y);
...
extern void frame_clientwin_resize(WFrame *frame, struct _WClientWin *cwin, int w, int h,
                                   bool dmax);
...
extern void clientwin_to_frame_size(int iw, int ih, int flags, int *fw, int *fh);
