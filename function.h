...
enum { ARGTYPE_NONE, ARGTYPE_INT, ARGTYPE_STRING, ARGTYPE_PTR };
...
typedef void WFuncHandler(WThing *thing, struct _WFunction *func, WFuncArg arg);
typedef void WButtonHandler(WThing *thing, XButtonEvent *ev, struct _WFunction *func, WFuncArg arg);
